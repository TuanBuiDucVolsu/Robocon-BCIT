...
| `docs/HAPPY_CASE.md` | **Bố cục kiện hàng dễ nhất khi TỰ ĐẶT được** (thi cấp trường). Cặp cùng loại → thả 1 lần 2 càng; nhà máy cùng hàng với kệ. Đo được: 12/12 kiện / 240 điểm so với 8/12 / 160 điểm khi trộn đều |
