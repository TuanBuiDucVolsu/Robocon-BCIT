...
| `docs/HAPPY_CASE.md` | **Bố cục kiện hàng tốt nhất khi TỰ ĐẶT được**. ⚠️ Mỗi cặp LUÔN là 2 nhà máy KHÁC nhau → 6 cặp = 6 cạnh đồ thị đủ 4 đỉnh, chỉ còn tự do việc gán vào 6 tầng (đã duyệt hết 720 cách). Cách xếp chỉ đáng ~20 điểm; thứ thật sự chặn là NGÂN SÁCH 240s |
