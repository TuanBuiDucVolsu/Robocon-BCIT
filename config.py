...
RETREAT_DISTANCE = 10.0      # Khoảng cách lùi ra sau khi nâng/hạ (cm) — fast-profile, CHƯA calibrate thật
...
# Động cơ cẩu:     5 chân (ENA_CAU_T, IN1_CAU_T, IN2_CAU_T, IN3_CAU_P, IN4_CAU_P)
...
PICKUP_VERIFY_DELAY = 0.2    # Thời gian chờ sau nâng trước khi kiểm tra cảm biến (giây) — fast-profile
...
SCAN_RETRY_DELAY = 0.05      # Thời gian chờ giữa các lần quét lại (giây) — fast-profile
