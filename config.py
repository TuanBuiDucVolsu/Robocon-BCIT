...
APPROACH_SPEED = 30          # Tốc độ tiến khi tiếp cận kệ (0-100)
...
# Đội cần đo thực tế số giao lộ và chỉnh lại!

# Từ xuất phát (R0 giữa) → Kệ 3 (R0 trái) — kệ gần nhất
ROUTE_START_TO_SHELF_0 = [
    ("left",),         # Rẽ trái hướng về cạnh trái
    ("forward", 1),    # Tiến đến Kệ 3 (cùng hàng R0)
]
...
# Từ nhà máy → quay về khu kệ
# Robot cần quay về cột trái (Col0) và đến kệ tiếp theo
